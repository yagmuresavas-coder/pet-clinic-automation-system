...
public class Owner { //Evcil havyan sahibinin bilgileri sınıfı
	...
	public Owner(String firstname, String lastname, String phonenumber, String email ) { //girdi olarak alınan değerleri kendi belirlediğimiz değişkenlere atıyoruz
